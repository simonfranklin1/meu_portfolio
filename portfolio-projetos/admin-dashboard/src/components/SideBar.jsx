...
const SideBar = () => {
  ...
  return (
    <Box sx={{
      ...
      "& .pro-inner-item": {
        padding: "5px 35px 5px 20px !importante"
      },
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square"> 
          ...
          {!isCollapsed && (
            <Box mb="25px">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img src={AdminPhoto} alt="profile-user" width="100px" height="100px" style={{ cursor: "pointer", borderRadius: "50%"}} />
              </Box>
          ...
          <Box paddinLeft={ isCollapsed ? null : "10%" }>
            ...
            <Item title="ProfileForm" to="/form" icon={<PersonOutlinedIcon />} selected={selected} setSelected={setSelected} />
