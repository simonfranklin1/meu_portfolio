...
`;function Bm(e,t,n){switch(n){case"bottom-left":return t?Lm:pm;case"bottom-right":return t?Tm:mm;case"down":return e?t?Rm:vm:t?Mm:hm;case"left":return e?t?$m:ym:t?Om:rs;case"right":return e?t?Fm:wm:t?Im:gm;case"top-left":return t?Dm:Sm;case"top-right":return t?Am:xm;case"up":return e?t?Um:Cm:t?Vm:km;default:return t?jm:dm}}const Qt=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=F.useMemo(()=>Bm(t,r,n),[t,n,r]);return re(os,{keyframes:i,...o})};k`
  from {
